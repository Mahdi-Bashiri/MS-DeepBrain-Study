...
# %%  Pre-processing
def main(flair_file_path, out_path, imaging_o='not_FS', imaging_w='T2W_F', voxel_size=[1,1,5])
    ...
    # Save brain info
    brain_info = out_path.replace('.nii.gz', '_binfo.npz')
    np.savez(brain_info, brain_cnt=brain_cnt, brain_ax=brain_ax, brain_mask=masks_data)
...
if __name__ == '__main__':
    ...
    for file in flair_file_paths_list:
        ...
        # preprocessing:
        main(flair_file_path, out_path, imaging_o, imaging_w, voxel_size)
